  ...
  return (
    <div className="">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Minecraft Server Status</h1>
        <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-2">
        <Link href="/mc/arena_builder"><Button size="sm" variant="outline">arena builder</Button></Link>
      </div>
            ...
            <CardContent className="p-4">
              <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
                <h2 className="text-xl font-semibold">
                  Minecraft Server: <span className="text-primary">{pingerStatus?.motd || "N/A"}</span>
                </h2>
              ...
              <div className="flex flex-col lg:flex-row justify-between gap-6">
                ...
                <div className="flex-shrink-0">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    />
                    <span className="font-bold">{pingerStatus?.status}</span>
                  </div>
                  <p className="text-sm"><strong>Version:</strong> {pingerStatus?.version || "-"}</p>
                  <p className="text-sm"><strong>Last Pinger:</strong> {timeAgo(pingerStatus?.last_ping_at)}</p>
                  <p className="text-sm"><strong>Last Restart:</strong> {timeAgo(pingerStatus?.last_restart_at)}</p>
                  <p className="text-sm"><strong>Restart Count:</strong> {pingerStatus?.restart_count}</p>
                </div>
                ...
                <div className="flex-shrink-0">
                  <h3 className="font-semibold text-muted-foreground mb-2">
                    Players ({realtimeStatus?.online_players ?? 0}/{realtimeStatus?.max_players ?? 0})
                  </h3>
