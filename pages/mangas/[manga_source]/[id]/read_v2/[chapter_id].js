...
export default function ReadManga(props) {
  ...
  function generateMetaImage() {
    ...
    return `${props.manga.cover_image[0].image_urls[0]}`
  }
...
export async function getServerSideProps(context) {
  ...
  return { props: { manga: manga, chapter: chapter, image_url: (query.image_url || "") } }
}
